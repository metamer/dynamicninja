...
public class DummyRunnerForUI implements Runner {
    ...
    private void InitTestUIState(){
        uiState = new UIState(generateGameMap(counter));
    ...
    private static GameMap generateGameMap(int i){
    ...
    private void UpdateTestUIState(){
        uiState.setGameMap(generateGameMap(counter));
        uiState.gameMapUpdated = true;
    }

    private UIState GenerateTestUIState(){
